      ...
      {state === "ok" ? (
        ...
        >
          ...
          <button
            ...
            className="min-h-11 bg-accent px-6 py-3 font-display text-15 font-bold tracking-wide12 text-on-accent uppercase transition-colors duration-[160ms] enabled:hover:bg-accent-alt enabled:hover:text-inset disabled:opacity-60"
          >
            {copy.submit}
          </button>
        </form>
