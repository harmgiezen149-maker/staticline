 ...
 *
 * Er zijn geen nieuwe kleuren, radii, schaduwen of bewegingen bijgekomen.
 */
type Props = {
  locale: Locale;
  ...
  return (
    <>
      ...
      <main className="px-5 py-8 sm:px-8 sm:py-12 lg:px-12 lg:py-16">
        ...
        {intro && (
          <p className="mt-6 max-w-[560px] text-14 leading-[22px] text-muted sm:text-16 sm:leading-[26px]">
            {intro}
          </p>
        )}
